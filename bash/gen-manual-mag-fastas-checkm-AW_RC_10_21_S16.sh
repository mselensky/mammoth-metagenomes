...
#SBATCH --job-name="generate-manual-mag-fastas-checkm-AW_RC_10_21_S16"
...
awk -F '\t' '!a[$2]++' ${metagenome}-manual-bins.txt | awk -F '\t' '{print $2}' > bin_names

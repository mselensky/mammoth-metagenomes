...
#SBATCH --job-name=gtdbtk-denovo_bacteria_MC-dereplicated
...
output_dir=/scratch/${USER}/dereplicated_bins_gtdbtk-denovo-wf
scratch=/scratch/${USER}/tmp-derep-bac-bins
...
gtdbtk de_novo_wf \
  ...
  --bacteria \
  --extension fa \
  --outgroup_taxon p__Fusobacteriota \
  --out_dir $output_dir \
  --cpus $SLURM_NTASKS

...
#SBATCH --job-name=quant_bins-mammoth_reassembled_mags
...
initial_bins=${parent_dir}/anvio-bins-frmttd2-manual_reassembled_bins/${metagenome}/reassembled_bins
output_dir=${parent_dir}/redundant_reassembled_bins_quant_12Apr23/${metagenome}
...
tmp_bin_dir=/scratch/${USER}/tmp-mammoth-reassembled-bins/${metagenome}
mkdir -p ${tmp_bin_dir}

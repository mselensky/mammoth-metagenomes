...
#SBATCH --job-name=iqtree-denovo_bacteria_MC-refined-mags
...
iqtree -s \
  ${proj_dir}/refined_bins_gtdbtk-denovo-wf_bacteria/align/gtdbtk.bac120.msa.fasta.gz \
  --prefix ${proj_dir}/refined-bins-bacteria-tree \
  -nt $SLURM_NTASKS \
  -mem 144G

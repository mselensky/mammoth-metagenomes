...
#SBATCH --job-name=gtdbtk-denovo_archaea_MC-refined-mags
...
output_dir=/projects/p30996/mammoth/metagenomes/refined_bins_gtdbtk-denovo-wf_archaea
scratch=/scratch/${USER}/refined_bins_50-10_compiled-archaea
...
gtdbtk de_novo_wf \
  ...
  --archaea \
  --extension fasta \
  --outgroup_taxon p__Thermoproteota \
  --out_dir $output_dir \
  --cpus $SLURM_NTASKS
